...
#define PIT_CHANNEL_0_TIMER	0x0000FA00 // 1 ms
#define PIT_CHANNEL_1_TIMER	0x0000FA00 // 1 ms; Initial value for start sona sensing
#define PIT_CHANNEL_2_TIMER	0x00001900 // 100 us
